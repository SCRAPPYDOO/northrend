...
struct MANGOS_DLL_DECL instance_nexus : public ScriptedInstance
{
    ...
    void OnCreatureCreate(Creature* pCreature)
    {
        ...
        switch(pCreature->GetEntry())
        {
			...
			case 26731: Telestra = pCreature->GetGUID(); break;
			case 26794: Ormorok  = pCreature->GetGUID(); break;

			case 26796: 
				{
					Stoutbeard = pCreature->GetGUID();
    ...
    uint64 GetData64(uint32 uiIdentifier)
    {
        switch(uiIdentifier)
        {
			...
			case DATA_TELESTRA:				return Telestra;
            case DATA_ORMOROK:				return Ormorok;
        }
        return 0;
    }
