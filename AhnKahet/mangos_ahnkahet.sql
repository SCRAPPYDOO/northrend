...
-- Ahn-Kahet::Swarmer
UPDATE creature_template SET `mindmg` = '250', `maxdmg` = '500', `baseattacktime` = '2000', `minhealth` = '150', `maxhealth` = '150' WHERE `entry` IN (30178);
UPDATE creature_template SET `mindmg` = '500', `maxdmg` = '1000', `baseattacktime` = '2000', `minhealth` = '250', `maxhealth` = '250' WHERE `entry` IN (31448);
-- Ahn-Kahet::Guardian
...
INSERT INTO `creature_loot_template` VALUES ('31464', '43102', '100', '2', '1', '1', '0', '0', '0');
